...
| --- | --- | --- | --- |
| `initialData` | [`object`](/docs/api/initialData) | The initial data that Axoview will render. If `undefined`, isoflow loads a blank scene. | `undefined` |
| `width` | `number` \| `string` | Width of the Axoview renderer as a CSS value. | `100%` |
| `height` | `number` \| `string` | Height of the Axoview renderer as a CSS value. | `100%` |
