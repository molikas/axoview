...
**Isopacks** are add-on modules for Axoview that contain icons and other assets.  You can easily build your own from scratch or create and load your own.
...
Below is a sample of icons available in the **Axoview** Isopack:
...
## Usage without Axoview

Isopacks can also be used without Axoview or React (for example, you can simply drag and drop the images into slides or documents, or import into your vanilla Javascript / Typescript project).
