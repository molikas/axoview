...
const locale: LocaleProps = {
  ...
  topBarStyleControls: {
    ...
    textColorDisabled:
      'Выберите узел, текст или подпись соединения, чтобы задать цвет текста',
    textSizeDisabled:
      'Выберите узел, текст или подпись соединения, чтобы задать размер текста',
    ...
    format: 'Жирный / курсив / зачёркнутый',
    formatDisabled:
      'Выберите узел, подпись или подпись соединения (текстовые поля форматируются через форматированный текст)',
    background: 'Цвет фона',
    backgroundDisabled: 'Выберите прямоугольник или подпись, чтобы задать цвет фона',
    ...
    showHideLabelDisabled: 'Выберите узел, чтобы показать или скрыть его подпись',
    ...
    iconSizeBulk: 'Размер иконки применяется к одному узлу за раз',
    ...
    richTextBulk: 'Форматированный текст редактируется в одном текстовом поле за раз',
    richText: 'Форматированный текст',
    richTextDisabled: 'Выберите текстовое поле, чтобы редактировать форматированный текст',
    text: 'Текст'
  },
  labelColorPicker: {
