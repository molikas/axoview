...
const locale: LocaleProps = {
  ...
  topBarStyleControls: {
    ...
    textSizeDisabled: '选择节点、文本框、标签或连接线标签以设置文本大小',
    labelSizeAllSelected: '标签大小（全部所选）',
    textColorAllSelected: '文本颜色（全部所选）',
    armedToolPlaceFirst: '新元素使用默认样式——先放置，再在此处设置样式',
    decreaseLabelSize: '减小标签大小',
    increaseLabelSize: '增大标签大小',
    labelSize: '标签大小',
    decreaseSize: '减小大小',
    increaseSize: '增大大小',
    stepAll: '统一调整',
    ...
    formatDisabled: '选择节点、文本框、标签或连接线标签以设置文本格式',
    lists: '列表',
    listsDisabled: '选择文本框以使用列表',
    bulletList: '项目符号列表',
    numberedList: '编号列表',
    background: '背景颜色',
    ...
    borderColor: '边框颜色',
    link: '链接',
    linkDisabled: '选择节点、连接线或标签以添加链接',
    linkSelection: '为所选文本添加链接',
    linkDisabledTextBox: '编辑时选中文本以添加链接',
    linkToWeb: '链接到网页',
    webLinkPlaceholder: 'https://…',
    linkToDiagram: '链接到图表',
    searchDiagrams: '搜索图表…',
    openLinkedDiagram: '打开链接的图表',
    showLabel: '显示标签',
    hideLabel: '隐藏标签',
    showHideLabelDisabled: '选择节点或连接线以显示或隐藏其标签',
    changeIconBulk: '更改图标一次只能应用于一个节点',
    changeIcon: '更改图标',
    changeIconDisabled: '选择节点以更改其图标',
    connectionColorPredraw: '接下来绘制的连接线的颜色',
    connectionColor: '连接线颜色',
    connectionColorDisabled: '选择连接线（或连接器工具）以设置其颜色',
    lineOptionsPredraw: '接下来绘制的连接线的线条样式',
    lineOptions: '线条选项',
