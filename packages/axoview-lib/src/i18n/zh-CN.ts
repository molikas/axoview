...
const locale: LocaleProps = {
  ...
  topBarStyleControls: {
    ...
    iconSize: '图标大小',
    textColor: '文本颜色',
    textColorDisabled: '选择节点、文本或连接线标签以设置文本颜色',
    textSizeDisabled: '选择节点、文本或连接线标签以设置文本大小',
    ...
    strikethrough: '删除线',
    format: '加粗 / 斜体 / 删除线',
    formatDisabled: '选择节点、标签或连接线标签（文本框通过富文本设置格式）',
    background: '背景颜色',
    ...
    showLabel: '显示标签',
    hideLabel: '隐藏标签',
    showHideLabelDisabled: '选择节点以显示或隐藏其标签',
    changeIconBulk: '更改图标一次只能应用于一个节点',
    changeIcon: '更改图标',
    changeIconDisabled: '选择节点以更改其图标',
    iconSizeBulk: '图标大小一次只能应用于一个节点',
    ...
    richTextBulk: '富文本一次只能编辑一个文本框',
    richText: '富文本',
    richTextDisabled: '选择文本框以编辑富文本',
    text: '文本'
  },
  labelColorPicker: {
    customColor: '自定义颜色'
