...
const locale: LocaleProps = {
  ...
  topBarStyleControls: {
    ...
    backgroundDisabled: 'Select a rectangle or label to set its background color',
    opacity: 'Opacity',
    border: 'Border',
    ...
    showHideLabelDisabled: 'Select a node to show or hide its label',
    changeIconBulk: 'Change icon applies to one node at a time',
    changeIcon: 'Change icon',
    changeIconDisabled: 'Select a node to change its icon',
    iconSizeBulk: 'Icon size applies to one node at a time',
    ...
    richTextBulk: 'Rich text edits one text box at a time',
    richText: 'Rich text',
    richTextDisabled: 'Select a text box to edit rich text',
    text: 'Text'
  },
  labelColorPicker: {
    customColor: 'Custom color'
