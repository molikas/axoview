...
- Productization audit (2026-03 → 2026-05) complete — see ADRs 0008–0011 + [docs/reviews/technical-review-2026-05.md](docs/reviews/technical-review-2026-05.md) for the durable record. v1.0.0 shipped 2026-05-23; M0–M10 milestone arc closed via 17 locked decisions across cleanup execution, ADR-implementation, deployment hardening, CI/automation hardening, and E2E rewrite. Sibling tacticals `e2e-suite-rewrite.md` + `git-automation-hardening.md` retained as session telemetry; `flare_plan.md` retired pre-audit (decisions absorbed into ADRs 0009 + 0010).
