...
_Generated 2026-06-15T19:51:56.136Z by packages/axoview-e2e/perf/engine-perf.spec.ts_

**KR1: CERTIFIED (load-bearing regime)** — worst noise band 6.2% < 10% across all drag cells and spawn N≥100. Baseline is trustworthy for the optimization-relevant range. (All-cells worst = 16.8%; the excess is small-N spawn ≤50 — sub-100 ms operations at the 16.6 ms vsync quantization floor, not an optimization target.)
...
|---|---|---|---|---|---|---|---|---|
| 25 | 16.7 | 16.7 | 16.66 | 16.7 | 83.3 | 0 | 8 | 16.8% |
| 50 | 16.7 | 16.7 | 16.67 | 16.7 | 83.35 | 0 | 8 | 13.5% |
| 100 | 16.7 | 29.2 | 19.45 | 33.35 | 116.7 | 66.5 | 8 | 5% |
| 200 | 16.7 | 41.7 | 22.23 | 50 | 133.4 | 128 | 8 | 6.2% |
| 500 | 16.7 | 91.63 | 33.33 | 116.6 | 199.95 | 463.5 | 8 | 4.5% |
| 1000 | 16.7 | 154.18 | 47.22 | 200 | 283.3 | 1119 | 8 | 2.1% |

## drag

| N | p50 (ms) | p95 (ms) | mean frame (ms) | longest frame (ms) | settle (ms) | long-task total (ms) | kept runs | noise band (CoV) |
|---|---|---|---|---|---|---|---|---|
| 25 | 16.7 | 16.75 | 16.67 | 16.8 | 1333.3 | 0 | 8 | 0% |
| 50 | 16.7 | 16.71 | 16.67 | 16.8 | 1333.25 | 0 | 8 | 0% |
| 100 | 16.7 | 16.7 | 16.67 | 16.8 | 1333.3 | 0 | 8 | 0% |
| 200 | 16.7 | 16.75 | 16.67 | 16.8 | 1333.3 | 0 | 8 | 0% |
| 500 | 16.7 | 16.8 | 16.87 | 33.3 | 1349.9 | 0 | 8 | 0% |
| 1000 | 16.7 | 16.7 | 16.67 | 16.8 | 1333.3 | 0 | 8 | 0.4% |
