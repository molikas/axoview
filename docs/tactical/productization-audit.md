...
```
   push/PR ──┬──> Run Tests ──┬─> Release (workflow_run success, rewired 2026-05-22)
             │                │
             │                └─> E2E Tests (workflow_run success)
             │                       │
             │                       └─> Dependabot Auto-Merge (PR-only, dependabot-only)
             │
   weekly + push/PR ─> EthicalCheck (deleted 2026-05-20; see A.8 #A3)
```
