...
| C.8 — Git-automation tactical | **in progress 2026-05-21+** — G9 (`8ee387a` 2026-05-21) + G2 (`967b2c7` 2026-05-22) + G1 (`4d74093` 2026-05-22) + G3 (`8574fca` 2026-05-22) + G8 (`72f12de` 2026-05-22) done; G5 dropped 2026-05-22 per Locked Decision #14; G4, G7, G10 remain (three rows). | [git-automation-hardening.md](git-automation-hardening.md) — see T2 row in C.2 Section 4 for the per-row status |
