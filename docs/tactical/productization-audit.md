...
| C.2 — Cleanup plan | **drafted 2026-05-20; Section 1 complete 2026-05-20** (Bundle A `264887a` Q1/Q3/Q4/Q6/Q7/Q8; Bundle B `39a44c1` Q2/Q5/Q9). **Section 2 complete 2026-05-20** (B1 `e307c68`; B2 `cff3942`; B3 `e0ee6f6`). **Section 3 Wave 3a complete 2026-05-20** (Bundle 3a-A `50146d2` I4/I5/I6/I7; Bundle 3a-B `6e1b28c` I2/I3). I8 held per release-window gate. Wave 3b (I1 dual-probe + I9 E2E deletion) remains. | [C.2 section above](#c2-cleanup-plan-drafted-2026-05-20) — 4-section spine (9 quick-wins · 3 bugs · 9 ADR-implementation rows · 4 spawned tacticals) + sequencing recommendation |
