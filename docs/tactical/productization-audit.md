...
| C.5 — E2E rewrite tactical | **scaffolded 2026-05-22** | [e2e-suite-rewrite.md](e2e-suite-rewrite.md) — locked scenario catalog (J1–J20 → 13 specs), POM inventory (8 surfaces), 8-session ~270K-token budget. Tracks T1 row in Section 4. |
