...
Rows seeded from the [manual-test-baseline](../manual-test-baseline.md) walk (Igor, 2026-05-21). All dispositions are **bug**; numbering is local (B-1..B-10) to avoid colliding with prior Q/I/B/T sequences. B-5 + B-6 executed first session; B-1 + B-2 + B-7 followed; B-3 + B-4 + B-8 land this polish session; B-9a shipped 2026-05-22; B-9b queued behind T1; B-10 filed 2026-05-22 from T2 G10 (knip soft-fail baseline) and queued for next polish wave.
