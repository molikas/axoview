...
Lib jest green (1154) + both libs build clean. **Owed before promotion:** run the new `import-export-image.spec` (needs a browser) + a manual export walkthrough (SVG opens valid · 4× large diagram · Screenshot preset labels).
