...
>
> **Status:** In progress — Slice 0 + A + B + C1 + E + G1 landed, plus a **beyond-plan UX slice** (connector decouple, placement cancel, Notes-on-all + Metadata deck, floating-Label edit, unified label sizing); **D1 + D2 + A5 done; F1 + F2 remain** before /ship · **Owner:** molikas · **Last updated:** 2026-07-02
>
