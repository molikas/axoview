...
**WebGL2 rendering** — The canvas renders on a WebGL2 sprite-batch substrate (one texture atlas, one draw call per layer): panning stays at 60 fps up to 20,000 nodes. See [ADR 0038](adr/0038-webgl2-rendering-substrate.md).
