...
- **Position:** ~~bottom-left corner~~ **top-left corner** (revised 2026-06-12 — shake-out: a
  ...
  of the BottomDock (the bottom bar holds the page selector and zoom controls now).
