...
The Google Cloud project is provisioned (project `axoview`, OAuth client ID `485371025824-2ullp84i3nda2dgceirg9q87fvm36kl8.apps.googleusercontent.com`) with three authorized JavaScript origins: `https://axoview.pages.dev`, `https://integration.axoview.pages.dev`, `http://localhost:3000`. The client ID is a public identifier, not a secret — origin restriction is the security boundary.
