...
**Status:** Accepted
**Date:** 2026-06-18
**Supersedes:** [ADR 0004](0004-connector-name-and-details-panel.md) §"Right-sidebar panel" in part — the panel's **Delete** button; this context menu owns Delete for every item type. 0004's name/notes parity substance stands.
*(Non-supersession context: spawned from [ADR 0022](0022-canvas-pointer-interaction-model.md) §1; home for [ADR 0023](0023-off-grid-positioning-and-collision.md) commands; touch reconciliation with [ADR 0018](0018-touch-pen-gesture-contract.md).)*
