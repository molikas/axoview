...
| `docs/` | **48** | 19 | +22 ADRs, [README.md index](README.md), [ux-principles.md](ux-principles.md), [perf-troubleshooting.md](perf-troubleshooting.md), [testing.md](testing.md), [workflow.md](workflow.md) promoted to living references (the 2026-06 "Path B" reorganization), this artifact |
...
Grep sweep against [ux-principles.md](ux-principles.md); counts are production source (lib+app), tests excluded:
...
Sweep against the [perf-troubleshooting.md](perf-troubleshooting.md) anti-pattern catalog:
...
4. **The four e2e-only gaps** ([testing.md](testing.md#known-coverage-gaps)) are release-noted as fast-follows. Agree/disagree with shipping them open, given each has a named spec+assertion and none is data-destructive.
...
Sources: [known_issues.md](../known_issues.md) (re-verified at freeze), [testing.md §Known Coverage Gaps](testing.md#known-coverage-gaps), PLAN.md registers, ADR "negative/open" sections, and this audit's sweeps.
...
10. **Close the four catalogued e2e-only gaps** — each has a named spec+assertion in [testing.md](testing.md#known-coverage-gaps).
