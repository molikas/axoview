# Upstream FossFLOW Changelog (pre-fork)

Verbatim copy of the [`stan-smith/FossFLOW`](https://github.com/stan-smith/FossFLOW) changelog as it stood at the fork point. Preserved here for traceability of pre-fork history; not maintained going forward.
