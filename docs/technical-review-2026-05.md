...
> **Status:** Artifact frozen 2026-05-23 (Sessions A + B + C complete). Corrections appendix added 2026-05-25. Reviewer-ready. This document is a snapshot of the post-M10 v1.0.0 state — it does not track ongoing changes; the [ADRs](adr/), [PLAN.md](../PLAN.md), and [docs/architecture.md](architecture.md) are the living artifacts.
